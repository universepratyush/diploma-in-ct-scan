...
const setActiveMobileTab = (tab) => {
    ...
    const commonTabButton = document.getElementById('commonTabButton');
    const departmentTabButton = document.getElementById('departmentTabButton');

    if (!commonSection || !departmentSection || !commonTabButton || !departmentTabButton) return;

    if (tab === 'common') {
        commonSection.classList.remove('hidden');
        departmentSection.classList.add('hidden');
        commonTabButton.classList.add('bg-slate-900', 'text-white');
        commonTabButton.classList.remove('bg-slate-200', 'text-slate-900');
        departmentTabButton.classList.add('bg-slate-200', 'text-slate-900');
        departmentTabButton.classList.remove('bg-slate-900', 'text-white');
    } else {
        departmentSection.classList.remove('hidden');
        commonSection.classList.add('hidden');
        departmentTabButton.classList.add('bg-slate-900', 'text-white');
        departmentTabButton.classList.remove('bg-slate-200', 'text-slate-900');
        commonTabButton.classList.add('bg-slate-200', 'text-slate-900');
        commonTabButton.classList.remove('bg-slate-900', 'text-white');
    }
};
...
const setupMobileTabs = () => {
    const commonTabButton = document.getElementById('commonTabButton');
    const departmentTabButton = document.getElementById('departmentTabButton');
    const switchToDepartment = document.getElementById('switchToDepartmentBtn');
    const switchToCommon = document.getElementById('switchToCommonBtn');

    if (commonTabButton) {
        commonTabButton.addEventListener('click', () => setActiveMobileTab('common'));
    }
    if (departmentTabButton) {
        departmentTabButton.addEventListener('click', () => setActiveMobileTab('department'));
    }
    if (switchToDepartment) {
        switchToDepartment.addEventListener('click', () => setActiveMobileTab('department'));
    }
    if (switchToCommon) {
        switchToCommon.addEventListener('click', () => setActiveMobileTab('common'));
    }
